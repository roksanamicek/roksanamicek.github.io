...
function preload() {
    // load graphics
    backgroundImg = loadImage("graphics/background2.png")
...
textAlign(CENTER)
textSize(8)
text("Press Escape to return to main menu", VIRTUAL_WIDTH / 2, VIRTUAL_HEIGHT - 10)
}

function checkIfHighScore() {
    let highScoreFlag = false
...
function play() {
    if (ball.collides(paddle)) {
        ...
        // tweak the angle of bounce based on where it hits paddle
